const facts = [
  ...
  {
    text: "Sebelum Masehi bahasa inggrisnya adalah B.C (Before Christ). Setelah Masehi adalah A.D (Anno Domini)",
    source:"https://fatihsaputro.wordpress.com/fakta-fakta-unik/250-fakta-unik-dan-menarik-dunia/",
  }, {
    text: "Ikan hiu kehilangan gigi lebih dari 6000buah setiap tahun, dan gigi barunya tumbuh dalam waktu 24 jam.",
    source:"https://fatihsaputro.wordpress.com/fakta-fakta-unik/250-fakta-unik-dan-menarik-dunia/",
  }, {
    text: " Julius Caesar tewas dengan 23 tikaman.",
    source:"https://fatihsaputro.wordpress.com/fakta-fakta-unik/250-fakta-unik-dan-menarik-dunia/",
  }, {
    text: "Nissan berasal dari 日 singkatan dari 日本 dan 産 singkatan dari 産業. Jadi nissan dalam bhs jepang adalah 日産 yg berarti produksi jepang,",
    source:"https://fatihsaputro.wordpress.com/fakta-fakta-unik/250-fakta-unik-dan-menarik-dunia/",
  }, {
    text: "Jerapah dan tikus bisa bertahan hidup lebih lama tanpa air dari pada unta",
    source:"https://fatihsaputro.wordpress.com/fakta-fakta-unik/250-fakta-unik-dan-menarik-dunia/",
  }, {
    text: "Perut memproduksi lapisan lendir setiap dua minggu agar perut tidak mencerna organnya sendiri.",
    source:"https://fatihsaputro.wordpress.com/fakta-fakta-unik/250-fakta-unik-dan-menarik-dunia/",
  }, {
    text: "98% dari perkosaan dan pembunuhan dilakukan oleh keluarga dekat atau teman korban.",
    source:"https://fatihsaputro.wordpress.com/fakta-fakta-unik/250-fakta-unik-dan-menarik-dunia/",
  }, {
    text: "Semut dapat mengangkat beban 50 kali tubuhnya",
    source:"https://fatihsaputro.wordpress.com/fakta-fakta-unik/250-fakta-unik-dan-menarik-dunia/",
  }, {
    text: "Deklarasi Kemerdekaan Amerika ditulis diatas kertas marijuana",
    source:"https://fatihsaputro.wordpress.com/fakta-fakta-unik/250-fakta-unik-dan-menarik-dunia/",
  }, {
    text: "Titik diatas huruf i disebut ‘title’",
    source:"https://fatihsaputro.wordpress.com/fakta-fakta-unik/250-fakta-unik-dan-menarik-dunia/",
  }, {
    text: "Sebutir kismis yang dijatuhkan kedalam gelas berisi sampanye segar akan bergerak naik turun dalam gelas",
    source:"https://fatihsaputro.wordpress.com/fakta-fakta-unik/250-fakta-unik-dan-menarik-dunia/",
  }, {
    text: "Benjamin Franklin anak bungsu dari orangtua bungsu keturunan ke 5 dalam keluarga bungsu.",
    source:"https://fatihsaputro.wordpress.com/fakta-fakta-unik/250-fakta-unik-dan-menarik-dunia/",
  }, {
    text: " Tanda ’save’ pada Microsoft Office programs menunjukan gambar floppy disk dengan shutter terbalik",
    source:"https://fatihsaputro.wordpress.com/fakta-fakta-unik/250-fakta-unik-dan-menarik-dunia/",
  }, {
    text: "Triskaidekaphobia adalah ketakutan pada 13",
    source:"https://fatihsaputro.wordpress.com/fakta-fakta-unik/250-fakta-unik-dan-menarik-dunia/",
  }, {
    text: "Paraskevidekatriaphobia adalah ketekukan pada hari jumat tanggal 13 (bisa terjadi antara 1-3 kali setahun).",
    source:"https://fatihsaputro.wordpress.com/fakta-fakta-unik/250-fakta-unik-dan-menarik-dunia/",
  }, {
    text: "di Italia, 17 adalah angka sial.",
    source:"https://fatihsaputro.wordpress.com/fakta-fakta-unik/250-fakta-unik-dan-menarik-dunia/",
  }, {
    text: "di jepang, 4 adalah angka sial.",
    source:"https://fatihsaputro.wordpress.com/fakta-fakta-unik/250-fakta-unik-dan-menarik-dunia/",
  }, {
    text: "Lidah jerapah panjangnya sekitar 50 cm",
    source:"https://fatihsaputro.wordpress.com/fakta-fakta-unik/250-fakta-unik-dan-menarik-dunia/",
  }, {
    text: "Mulut menghasilkan 1 liter ludah setiap hari",
    source:"https://fatihsaputro.wordpress.com/fakta-fakta-unik/250-fakta-unik-dan-menarik-dunia/",
  }, {
    text: "Kita bernafas kira-kira 23.000 kali setiap hari",
    source:"https://fatihsaputro.wordpress.com/fakta-fakta-unik/250-fakta-unik-dan-menarik-dunia/",
  }, {
    text: "Kata ZIP (kode pos) adalah kepanjangan dari ‘Zoning Improvement Plan’.",
    source:"https://fatihsaputro.wordpress.com/fakta-fakta-unik/250-fakta-unik-dan-menarik-dunia/",
  }, {
    text: "Coca-Cola mengandung Coca (yang merupakan zat aktif pada kokain) dari tahun 1885 sampai 1903.",
    source:"https://fatihsaputro.wordpress.com/fakta-fakta-unik/250-fakta-unik-dan-menarik-dunia/",
  }, {
    text: "Rata-rata kita bicara 5000 kata tiap hari (walaupun 80% nya kita bicara pada diri sendiri)",
    source:"https://fatihsaputro.wordpress.com/fakta-fakta-unik/250-fakta-unik-dan-menarik-dunia/",
  }, {
    text: "Seandainya kuota air dalam tubuh kita berkurang 1%, kita langsung merasa haus",
    source:"https://fatihsaputro.wordpress.com/fakta-fakta-unik/250-fakta-unik-dan-menarik-dunia/",
  }, {
    text: "4 simbol raja pada kartu remi melambangkan 4 raja yang etrkenal di jaman masing-masing: Sekop = David/Raja Daud ; Keriting = Alexander the Great/Iskandar Agung ; Hati = Charlemagne/ Raja Prancis ; Wajik =Julius Caesar",
    source:"https://fatihsaputro.wordpress.com/fakta-fakta-unik/250-fakta-unik-dan-menarik-dunia/",
  }, {
    text: "Seumur hidup kita meminum air sebanyak kurang lebih 75.000 liter",
    source:"https://fatihsaputro.wordpress.com/fakta-fakta-unik/250-fakta-unik-dan-menarik-dunia/",
  }, {
    text: "Setiap orang, termasuk kembar identik, sidik jari dan tekstur lidahnya tidak ada yang sama.",
    source:"https://fatihsaputro.wordpress.com/fakta-fakta-unik/250-fakta-unik-dan-menarik-dunia/",
  }, {
    text: "Titik merah pada 7-Up logo berasal dari penemunya yang bermata merah. Dia seorang albino.",
    source:"https://fatihsaputro.wordpress.com/fakta-fakta-unik/250-fakta-unik-dan-menarik-dunia/",
  }, {
    text: "Pria kehilangan 40 helai rambut tiap hari. wanita 70 helai.",
    source:"https://fatihsaputro.wordpress.com/fakta-fakta-unik/250-fakta-unik-dan-menarik-dunia/",
  },{
    text: "f",
    source:"https://besd",
...
$(document).ready(function() {
    var factNum = Math.floor(Math.random() * facts.length);
    var randomFact = facts[factNum].text;
    var source = facts[factNum].source;
  
    function loadQuote(arr) {
      if (factNum === arr.length - 1) {
        factNum = 0;
        return arr[factNum].text;
      } else {
        factNum += 1;
        return arr[factNum].text;
      }
    ...
    $factBtn.on("click", function(e) {
      e.preventDefault();
      $quote.addClass("animated bounceOut").one('webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend', function() {
        $(this).removeClass("animated bounceOut").html(loadQuote(facts));
      });
    });
    
    quoted = loadQuote(facts);
    
    $('#tweet').attr('href', 'https://twitter.com/intent/tweet?hashtags=' + "Facts no:" + factNum +'&text=' + '"' + randomFact + '"' + '\n' + ' Source: ' + '&url='  + source);
    $('#random-quote').attr('href', 'https://twitter.com/intent/tweet?hashtags=' + "Facts no:" + factNum +'&text=' + '"' + quoted + '"' + ' Source: ' + '&url='  + source);
    // $('#rok').attr('href', 'https://twitter.com/intent/tweet?text=' + tuk);
  ...
  function copybut() {
    document.getElementById('copybut').style.display = "block";
 }

 (function() {
    var _url = "https://api.icndb.com/jokes/random";
    $.getJSON(_url, function(data) {
        format: "json";
    }).done(function(object) {
        console.log(object.value.joke);
        $('<h3>' +'"'+ object.value.joke +'"'+ '</h3>').appendTo("#joke");
    });
})();
